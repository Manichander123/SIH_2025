...
// 1. Define the props interface to accept the click handler
interface HeaderProps {
  onSignInClick: () => void;
}

const Header: React.FC<HeaderProps> = ({ onSignInClick }) => { // 2. Receive the prop
          ...
          <div className="lg:hidden py-4 border-t border-gray-200">
            <nav className="flex flex-col space-y-4">
              ...
              {user ? (
                ...
                // 4. Add the onClick handler to the mobile button as well
                <button 
                  onClick={onSignInClick}
